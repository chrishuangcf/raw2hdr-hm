  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 p-6 md:p-8 my-12 shadow-2xl relative z-10">
      <div className="text-center mb-8 relative z-20">
        <h3 className="text-2xl md:text-3xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">
          Visualizing the Headroom
        </h3>
        <p className="text-gray-400 max-w-2xl mx-auto">
          See the invisible. Standard images clip bright highlights and crush shadows. 
          10-bit HDR preserves the full signal captured by your sensor.
        </p>
      </div>
